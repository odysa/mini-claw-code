...
#[tokio::test]
async fn test_ch20_logging_hook() {
...
#[tokio::test]
async fn test_ch20_logging_hook_multiple_events() {
    let hook = LoggingHook::new();
...
#[tokio::test]
async fn test_ch20_blocking_hook() {
...
#[tokio::test]
async fn test_ch20_blocking_hook_allows_other_tools() {
...
#[tokio::test]
async fn test_ch20_registry_dispatch_continue() {
...
#[tokio::test]
async fn test_ch20_registry_dispatch_block() {
...
#[tokio::test]
async fn test_ch20_registry_multiple_hooks_order() {
...
#[tokio::test]
async fn test_ch20_registry_block_short_circuits() {
...
#[test]
fn test_ch20_registry_is_empty() {
    let registry = HookRegistry::new();
...
#[tokio::test]
async fn test_ch20_post_tool_event() {
    let hook = LoggingHook::new();
