...
#[test]
fn test_instructions_discover_in_current_dir() {
...
#[test]
fn test_instructions_discover_in_parent() {
...
#[test]
fn test_instructions_no_files_found() {
    let dir = tempfile::tempdir().unwrap();
...
#[test]
fn test_instructions_load_content() {
    let dir = tempfile::tempdir().unwrap();
...
#[test]
fn test_instructions_load_empty_file() {
    let dir = tempfile::tempdir().unwrap();
...
#[test]
fn test_instructions_multiple_file_names() {
    let dir = tempfile::tempdir().unwrap();
...
#[test]
fn test_instructions_system_prompt_section() {
    let dir = tempfile::tempdir().unwrap();
...
#[test]
fn test_instructions_default_files() {
