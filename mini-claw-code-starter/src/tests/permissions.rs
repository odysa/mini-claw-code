...
#[test]
fn test_permissions_glob_pattern() {
...
#[test]
fn test_permissions_first_rule_wins() {
    let rules = vec![
...
#[test]
fn test_permissions_session_allow() {
...
#[test]
fn test_permissions_session_allow_per_tool() {
    let mut engine = PermissionEngine::ask_by_default(vec![]);
...
#[test]
fn test_permissions_is_allowed() {
    let rules = vec![
        PermissionRule::new("read", Permission::Allow),
        PermissionRule::new("write", Permission::Deny),
    ];
...
#[test]
fn test_permissions_needs_approval() {
...
#[test]
fn test_permissions_wildcard_rule() {
...
#[test]
fn test_permissions_deny_overrides_default() {
