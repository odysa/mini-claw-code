...
#[test]
fn test_streaming_accumulator_text() {
...
#[test]
fn test_streaming_accumulator_tool_call() {
    let mut acc = StreamAccumulator::new();
...
#[test]
fn test_streaming_accumulator_empty() {
...
#[test]
fn test_streaming_accumulator_text_and_tool() {
    let mut acc = StreamAccumulator::new();
...
#[test]
fn test_streaming_accumulator_multiple_tool_calls() {
    let mut acc = StreamAccumulator::new();
    acc.feed(&StreamEvent::ToolCallStart {
        index: 0,
        id: "c1".into(),
...
#[test]
fn test_streaming_accumulator_default() {
...
#[test]
fn test_streaming_parse_text_delta() {
...
#[test]
fn test_streaming_parse_tool_call_start() {
...
#[test]
fn test_streaming_parse_tool_call_delta() {
...
#[test]
fn test_streaming_parse_done() {
    let events = parse_sse_line("data: [DONE]").unwrap();
    assert_eq!(events, vec![StreamEvent::Done]);
}

#[test]
fn test_streaming_parse_non_data_lines() {
...
#[test]
fn test_streaming_parse_empty_delta() {
...
#[test]
fn test_streaming_parse_invalid_json() {
    assert!(parse_sse_line("data: {not json}").is_none());
}

#[test]
fn test_streaming_parse_multiple_text_chunks() {
    let lines = [
...
#[test]
fn test_streaming_parse_tool_call_full_sequence() {
...
#[tokio::test]
async fn test_streaming_stream_chat_text() {
...
#[tokio::test]
async fn test_streaming_stream_chat_tool_call() {
    use tokio::io::{AsyncReadExt, AsyncWriteExt};
    use tokio::net::TcpListener;
...
#[tokio::test]
async fn test_streaming_mock_stream_provider_text() {
...
#[tokio::test]
async fn test_streaming_mock_stream_provider_tool_call() {
    use std::collections::VecDeque;
...
#[tokio::test]
async fn test_streaming_streaming_agent_text_response() {
    use std::collections::VecDeque;
    use tokio::sync::mpsc;
...
#[tokio::test]
async fn test_streaming_streaming_agent_tool_loop() {
    use std::collections::VecDeque;
    use tokio::sync::mpsc;
...
#[tokio::test]
async fn test_streaming_streaming_agent_chat_history() {
    use std::collections::VecDeque;
    use tokio::sync::mpsc;
...
#[tokio::test]
async fn test_streaming_stream_chat_events_order() {
    use tokio::io::{AsyncReadExt, AsyncWriteExt};
    use tokio::net::TcpListener;
