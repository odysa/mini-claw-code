...
#[tokio::test]
#[ignore = "bonus: requires SubagentTool implementation (Ch13)"]
async fn test_subagent_subagent_text_response() {
...
#[tokio::test]
#[ignore = "bonus: requires SubagentTool implementation (Ch13)"]
async fn test_subagent_subagent_with_tool() {
...
#[tokio::test]
#[ignore = "bonus: requires SubagentTool implementation (Ch13)"]
async fn test_subagent_subagent_multi_step() {
    let dir = tempfile::tempdir().unwrap();
...
#[tokio::test]
#[ignore = "bonus: requires SubagentTool implementation (Ch13)"]
async fn test_subagent_max_turns_exceeded() {
...
#[tokio::test]
#[ignore = "bonus: requires SubagentTool implementation (Ch13)"]
async fn test_subagent_subagent_missing_task() {
...
#[tokio::test]
#[ignore = "bonus: requires SubagentTool implementation (Ch13)"]
async fn test_subagent_subagent_unknown_tool_in_child() {
    let provider = Arc::new(MockProvider::new(VecDeque::from([
...
#[test]
#[ignore = "bonus: requires SubagentTool implementation (Ch13)"]
fn test_subagent_builder_pattern() {
    let provider = Arc::new(MockProvider::new(VecDeque::new()));
...
#[tokio::test]
#[ignore = "bonus: requires SubagentTool implementation (Ch13)"]
async fn test_subagent_system_prompt_in_child() {
...
#[tokio::test]
#[ignore = "bonus: requires SubagentTool implementation (Ch13)"]
async fn test_subagent_subagent_with_write_tool() {
    let dir = tempfile::tempdir().unwrap();
...
#[tokio::test]
#[ignore = "bonus: requires SubagentTool implementation (Ch13)"]
async fn test_subagent_parent_continues_after_subagent() {
    let dir = tempfile::tempdir().unwrap();
...
#[tokio::test]
#[ignore = "bonus: requires SubagentTool implementation (Ch13)"]
async fn test_subagent_isolated_message_history() {
    let provider = Arc::new(MockProvider::new(VecDeque::from([
        // Parent turn 1: call subagent
        AssistantTurn {
            text: None,
