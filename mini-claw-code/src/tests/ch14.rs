...
#[test]
fn test_ch14_record_single_turn() {
    let tracker = CostTracker::new(3.0, 15.0);
...
#[test]
fn test_ch14_accumulates_across_turns() {
    let tracker = CostTracker::new(3.0, 15.0);
    tracker.record(&TokenUsage {
        input_tokens: 100,
        output_tokens: 50,
...
#[test]
fn test_ch14_token_usage_default() {
