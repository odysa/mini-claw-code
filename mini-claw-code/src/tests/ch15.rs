...
#[tokio::test]
async fn test_ch15_compact_preserves_system_prompt() {
...
#[tokio::test]
async fn test_ch15_compact_too_few_messages() {
...
#[tokio::test]
async fn test_ch15_maybe_compact_skips_when_not_needed() {
    let provider = MockProvider::new(VecDeque::new());
...
#[tokio::test]
async fn test_ch15_compact_preserves_recent() {
    let provider = MockProvider::new(VecDeque::from([AssistantTurn {
