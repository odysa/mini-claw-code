...
#[test]
fn test_ch21_convert_tool_defs_empty() {
    let defs = McpClient::convert_tool_defs(&[], "test");
    assert!(defs.is_empty());
}

#[test]
fn test_ch21_convert_tool_defs_single() {
...
#[test]
fn test_ch21_convert_tool_defs_no_description() {
    let mcp_tools = vec![McpToolDef {
        name: "my_tool".into(),
        description: None,
        input_schema: None,
...
#[test]
fn test_ch21_convert_tool_defs_multiple() {
    let mcp_tools = vec![
        McpToolDef {
            name: "tool_a".into(),
...
#[test]
fn test_ch21_mcp_tool_def_deserialize() {
    let json = json!({
        "name": "get_weather",
...
#[test]
fn test_ch21_mcp_tool_def_minimal() {
...
#[test]
fn test_ch21_jsonrpc_request_format() {
...
#[test]
fn test_ch21_jsonrpc_request_with_params() {
    use crate::mcp::types::JsonRpcRequest;
...
#[test]
fn test_ch21_tool_call_result_deserialize() {
