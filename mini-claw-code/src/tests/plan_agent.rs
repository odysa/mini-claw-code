...
#[tokio::test]
async fn test_plan_agent_plan_text_response() {
...
#[tokio::test]
async fn test_plan_agent_plan_with_read_tool() {
...
#[tokio::test]
async fn test_plan_agent_plan_blocks_write_tool() {
    let dir = tempfile::tempdir().unwrap();
...
#[tokio::test]
async fn test_plan_agent_plan_blocks_edit_tool() {
    let dir = tempfile::tempdir().unwrap();
...
#[tokio::test]
async fn test_plan_agent_execute_allows_write_tool() {
    let dir = tempfile::tempdir().unwrap();
...
#[tokio::test]
async fn test_plan_agent_full_plan_then_execute() {
    let dir = tempfile::tempdir().unwrap();
...
#[tokio::test]
async fn test_plan_agent_message_continuity() {
    let provider = MockStreamProvider::new(VecDeque::from([
        // Plan phase
        AssistantTurn {
...
#[tokio::test]
async fn test_plan_agent_read_only_override() {
...
#[tokio::test]
async fn test_plan_agent_streaming_events_during_plan() {
    let provider = MockStreamProvider::new(VecDeque::from([AssistantTurn {
...
#[tokio::test]
async fn test_plan_agent_plan_provider_error() {
...
#[test]
fn test_plan_agent_builder_pattern() {
    let provider = MockStreamProvider::new(VecDeque::new());
...
#[tokio::test]
async fn test_plan_agent_system_prompt_injected() {
    let provider = MockStreamProvider::new(VecDeque::from([AssistantTurn {
        text: Some("ok".into()),
        tool_calls: vec![],
        stop_reason: StopReason::Stop,
...
#[tokio::test]
async fn test_plan_agent_system_prompt_not_duplicated() {
    let provider = MockStreamProvider::new(VecDeque::from([
        AssistantTurn {
...
#[tokio::test]
async fn test_plan_agent_caller_system_prompt_respected() {
    let provider = MockStreamProvider::new(VecDeque::from([AssistantTurn {
        text: Some("ok".into()),
        tool_calls: vec![],
        stop_reason: StopReason::Stop,
...
#[tokio::test]
async fn test_plan_agent_exit_plan_tool() {
    let dir = tempfile::tempdir().unwrap();
...
#[tokio::test]
async fn test_plan_agent_exit_plan_not_in_execute() {
...
#[tokio::test]
async fn test_plan_agent_custom_plan_prompt() {
    let provider = MockStreamProvider::new(VecDeque::from([AssistantTurn {
        text: Some("ok".into()),
        tool_calls: vec![],
        stop_reason: StopReason::Stop,
...
#[tokio::test]
async fn test_plan_agent_full_flow_with_exit_plan() {
    let dir = tempfile::tempdir().unwrap();
